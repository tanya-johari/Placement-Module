...
// ***************************************************************//////////
//////////////////ROUTE FOR REGISTERATION FOR DRIVE /////////////
app.post("/registerdrive", (req, res) => {
  const usn = req.body.usn;
  const cname = req.body.cname;
  const position = req.body.position;
  
  db.query(
    "INSERT INTO regdrive (usn,cname,position) VALUES (?,?,?)",
    [usn, cname, position ],
...
/////////////////////ROUTE FOR REFER COMPANIES /////////////
app.post("/refercompany", (req, res) => {
  const cname = req.body.cname;
  const cdescription = req.body.cdescription;
  const email = req.body.email;
  const phone = req.body.phone;
